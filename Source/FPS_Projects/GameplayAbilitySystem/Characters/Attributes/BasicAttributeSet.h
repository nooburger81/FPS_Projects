 ...
 */
UCLASS()
class FPS_PROJECTS_API UBasicAttributeSet : public UAttributeSet
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "Attributes", ReplicatedUsing = OnRep_MaxHealth)
	...
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "Attributes", ReplicatedUsing = OnRep_MaxStamina)
